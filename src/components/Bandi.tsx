    ...
    <section className="relative overflow-hidden pt-36 pb-32 bg-[#F0EFEB] text-left">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            <div className="text-[10px] font-bold text-[#F2C400] uppercase tracking-widest font-mono">{t('bandi.campaniaDate')}</div>
            
            <h3 className="text-xl font-bold font-sans text-[#2C2C2E] tracking-tight">{t('bandi.campaniaTitle')}</h3>

            <div className="p-4 rounded-xl text-xs space-y-1 bg-[#F2C400]/5 border border-[#F2C400]/15 font-mono text-[#2C2C2E]/90">
            ...
            <ul className="space-y-1.5 font-mono text-xs sm:text-sm text-[#5E5E62]">
              <li className="flex items-start gap-2">
                <span className="text-[#F2C400] mt-0.5">•</span>
          ...
          >
            ...
            <div className="p-4 rounded-xl text-xs bg-[#F2C400]/5 border border-[#F2C400]/15 font-mono text-[#2C2C2E]/90">
          ...
          <motion.div 
            variants={itemVariants}
            className="p-6 card-premium border-[#F2C400]/15 bg-white/50 hover:border-[#F2C400]/30 transition-all duration-300"
          >
            <div className="flex flex-col md:flex-row gap-6 items-start md:items-center justify-between">
              <div className="space-y-3 flex-1">
                <div className="text-[9px] font-bold text-[#F2C400] uppercase tracking-widest font-mono">{t('bandi.patentBadge')}</div>
              ...
              <div className="w-full md:w-auto shrink-0 p-4 rounded-xl text-[11px] bg-[#F2C400]/5 border border-[#F2C400]/10 font-mono text-[#2C2C2E]/85 space-y-1 md:min-w-[280px]">
