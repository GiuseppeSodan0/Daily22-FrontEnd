...
export default function Salvatore() {
  ...
  useEffect(() => {
    document.title = isEn 
      ? "Salvatore | Virtual AI Consultant for Occupational Safety"
      : "Salvatore | Consulente virtuale IA per la sicurezza sul lavoro";
    ...
    metaDesc.setAttribute(
      'content',
      isEn
        ? "Discover Salvatore, the AI virtual consultant of the daily ecosystem, designed to assist workers and companies in understanding risks, PPE, procedures, and safe behaviors."
        : 'Scopri Salvatore, il consulente virtuale con Intelligenza Artificiale dell’ecosistema daily, progettato per supportare lavoratori e aziende nella comprensione di rischi, DPI, procedure e comportamenti sicuri.'
    );
  }, [isEn]);
  ...
  return (
    <div className="bg-[#F0EFEB] text-[#2C2C2E] font-sans overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              >
                <MessageSquare className="w-3.5 h-3.5 text-[#F2C400]" />
                <span>{isEn ? 'Virtual Consultant' : 'Consulente Virtuale'}</span>
              </motion.span>
              ...
              >
                {isEn 
                  ? 'The virtual consultant for simpler, continuous, and accessible safety.'
                  : 'Il consulente virtuale per una sicurezza più semplice, continua e accessibile.'}
              </motion.h2>
              ...
              >
                {isEn
                  ? 'Salvatore is the Artificial Intelligence assistant of the daily ecosystem, designed to support workers, companies, and safety managers in understanding risks, procedures, and safe conduct.'
                  : 'Salvatore è l’assistente con Intelligenza Artificiale dell’ecosistema daily, progettato per supportare lavoratori, aziende e figure della prevenzione nella comprensione dei rischi, delle procedure e dei comportamenti sicuri.'}
              </motion.p>
              ...
              >
                {isEn
                  ? 'It interacts in natural language, answers operational questions, and turns complex technical and regulatory documents into clear, actionable guidance.'
                  : 'Interagisce in linguaggio naturale, risponde alle domande operative e aiuta a trasformare informazioni tecniche e documentali in indicazioni più chiare, immediate e utilizzabili.'}
              </motion.p>
              ...
              >
                ...
                >
                  {isEn ? 'Discover how it works' : 'Scopri come funziona'}
            ...
            <div className="lg:col-span-5 flex justify-center items-center w-full relative">
              ...
              <div className="absolute w-[320px] h-[320px] rounded-full bg-gradient-to-tr from-[#F2C400]/8 to-transparent blur-3xl pointer-events-none -z-10" />
              
              {/* Discrete reactive decorative elements or glowing nodes */}
              <div className="absolute top-[10%] left-[15%] w-2 h-2 rounded-full bg-[#F2C400] animate-pulse opacity-60" />
              <div className="absolute bottom-[20%] right-[10%] w-1.5 h-1.5 rounded-full bg-[#2C2C2E]/30" />
              <div className="absolute top-[40%] right-[5%] w-2.5 h-2.5 rounded-full bg-[#F2C400]/40" />
              
              {/* Circular light outline to represent connection rings, extremely subtle */}
              <div className="absolute w-[280px] h-[280px] rounded-full border border-[#F2C400]/10 -z-10 animate-[spin_120s_linear_infinite]" />
      ...
      {/* 2. SEZIONE "PERCHÉ SALVATORE" (Con layout dinamico e interconnessioni) */}
      <section className="py-24 bg-white text-left relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <h3 className="text-base sm:text-lg font-mono text-[#F2C400] font-bold uppercase tracking-wide mt-2">
              {isEn 
                ? 'Safety shouldn’t be hard to understand. It must be accessible right when needed.'
                : 'La sicurezza non deve essere difficile da capire. Deve essere accessibile nel momento in cui serve.'}
            </h3>
            <p className="mt-6 text-xs sm:text-sm font-mono text-[#5E5E62] leading-relaxed">
              {isEn
                ? 'In operational environments, procedures, obligations, PPE, job roles, and instructions can be cumbersome to consult. Salvatore makes this information immediate, turning technical contents into clear, contextual, action-oriented answers.'
                : 'Nei contesti lavorativi, procedure, obblighi, DPI, mansioni e istruzioni operative possono essere complessi da consultare e interpretare. Salvatore nasce per rendere queste informazioni più immediate, trasformando contenuti tecnici in risposte comprensibili, contestuali e orientate all’azione.'}
            </p>
          </div>

          {/* Interactive Connected Elements Flow */}
          <div className="relative mt-20">
            {/* Fine connecting horizontal line for desktop, hidden on mobile */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-8 relative z-10">
              ...
              {/* Card 1 */}
              <div className="p-6 rounded-2xl bg-[#F0EFEB]/50 border border-black/5 hover:bg-white hover:border-[#F2C400]/70 hover:-translate-y-1.5 hover:shadow-[0_20px_48px_rgba(44,44,46,0.12)] transition-all duration-300 group flex flex-col justify-between h-full relative cursor-pointer">
                {/* Node indicator for connection line */}
                <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 w-3 h-3 bg-white border-2 border-black/20 rounded-full z-20 group-hover:border-[#F2C400] group-hover:bg-[#F2C400] group-hover:scale-125 transition-all duration-300 hidden lg:block" />
                
                <div className="space-y-4">
                  <div className="w-8 h-8 rounded-lg bg-[#2C2C2E]/5 group-hover:bg-[#F2C400]/20 flex items-center justify-center text-xs font-mono font-bold text-[#2C2C2E] transition-colors">01</div>
                  <h4 className="text-base font-bold font-sans text-[#2C2C2E] tracking-tight group-hover:text-[#F2C400] transition-colors">
                    {isEn ? 'Complex Documents' : 'Documenti complessi'}
                  </h4>
                  <p className="text-[11.5px] leading-relaxed text-[#5E5E62] font-mono">
                    {isEn
                      ? 'Risk assessments, emergency plans, and regulations are often bureaucratic binders difficult to consult during a work shift.'
                      : 'DVR, piani di emergenza e normative sono spesso faldoni burocratici difficili da consultare velocemente durante il turno lavorativo.'}
                  </p>
                </div>
              </div>
              ...
              {/* Card 2 */}
              <div className="p-6 rounded-2xl bg-[#F0EFEB]/50 border border-black/5 hover:bg-white hover:border-[#F2C400]/70 hover:-translate-y-1.5 hover:shadow-[0_20px_48px_rgba(44,44,46,0.12)] transition-all duration-300 group flex flex-col justify-between h-full relative cursor-pointer">
                <div className="absolute -top-4 left-1/2 -translate-x-1/2 w-3 h-3 bg-white border-2 border-black/20 rounded-full z-20 group-hover:border-[#F2C400] group-hover:bg-[#F2C400] group-hover:scale-125 transition-all duration-300 hidden lg:block" />
                
                <div className="space-y-4">
                  <div className="w-8 h-8 rounded-lg bg-[#2C2C2E]/5 group-hover:bg-[#F2C400]/20 flex items-center justify-center text-xs font-mono font-bold text-[#2C2C2E] transition-colors">02</div>
                  <h4 className="text-base font-bold font-sans text-[#2C2C2E] tracking-tight group-hover:text-[#F2C400] transition-colors">
                    {isEn ? 'Fast Answers' : 'Risposte rapide'}
                  </h4>
                  <p className="text-[11.5px] leading-relaxed text-[#5E5E62] font-mono">
                    {isEn
                      ? 'Workers need to know immediately if a task requires specific PPE, without flipping through hundreds of pages.'
                      : 'Un lavoratore ha bisogno di sapere immediatamente se una determinata procedura richiede un DPI specifico, senza sfogliare centinaia di pagine.'}
                  </p>
                </div>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-[#F0EFEB]/50 border border-black/5 hover:bg-white hover:border-[#F2C400]/70 hover:-translate-y-1.5 hover:shadow-[0_20px_48px_rgba(44,44,46,0.12)] transition-all duration-300 group flex flex-col justify-between h-full relative cursor-pointer">
                ...
                <div className="space-y-4">
                  <div className="w-8 h-8 rounded-lg bg-[#2C2C2E]/5 group-hover:bg-[#F2C400]/20 flex items-center justify-center text-xs font-mono font-bold text-[#2C2C2E] transition-colors">03</div>
                  <h4 className="text-base font-bold font-sans text-[#2C2C2E] tracking-tight group-hover:text-[#F2C400] transition-colors">
                    {isEn ? 'Real Support' : 'Supporto reale'}
                  </h4>
                  <p className="text-[11.5px] leading-relaxed text-[#5E5E62] font-mono">
                    {isEn
                      ? 'Salvatore offers 24/7 contextual operational assistance right in the palm of every operator’s hand.'
                      : 'Salvatore offre assistenza e supporto operativo contestuale 24 ore su 24, direttamente nel palmo della mano di ciascun operatore.'}
                  </p>
                </div>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-[#F0EFEB]/50 border border-black/5 hover:bg-white hover:border-[#F2C400]/70 hover:-translate-y-1.5 hover:shadow-[0_20px_48px_rgba(44,44,46,0.12)] transition-all duration-300 group flex flex-col justify-between h-full relative cursor-pointer">
                ...
                <div className="space-y-4">
                  <div className="w-8 h-8 rounded-lg bg-[#2C2C2E]/5 group-hover:bg-[#F2C400]/20 flex items-center justify-center text-xs font-mono font-bold text-[#2C2C2E] transition-colors">04</div>
                  <h4 className="text-base font-bold font-sans text-[#2C2C2E] tracking-tight group-hover:text-[#F2C400] transition-colors">
                    {isEn ? 'Plain Language' : 'Linguaggio semplice'}
                  </h4>
                  <p className="text-[11.5px] leading-relaxed text-[#5E5E62] font-mono">
                    {isEn
                      ? 'Bureaucratic complexity and hard terms are translated instantly into practical, direct, accessible safety steps.'
                      : 'La complessità burocratica e i termini difficili vengono tradotti all\'istante in indicazioni di sicurezza pratiche, dirette e accessibili.'}
                  </p>
                </div>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-[#F0EFEB]/50 border border-black/5 hover:bg-white hover:border-[#F2C400]/70 hover:-translate-y-1.5 hover:shadow-[0_20px_48px_rgba(44,44,46,0.12)] transition-all duration-300 group flex flex-col justify-between h-full relative cursor-pointer">
                ...
                <div className="space-y-4">
                  <div className="w-8 h-8 rounded-lg bg-[#2C2C2E]/5 group-hover:bg-[#F2C400]/20 flex items-center justify-center text-xs font-mono font-bold text-[#2C2C2E] transition-colors">05</div>
                  <h4 className="text-base font-bold font-sans text-[#2C2C2E] tracking-tight group-hover:text-[#F2C400] transition-colors">
                    {isEn ? 'Close Prevention' : 'Prevenzione vicina'}
                  </h4>
                  <p className="text-[11.5px] leading-relaxed text-[#5E5E62] font-mono">
                    {isEn
                      ? 'Breaks down cultural and language barriers, turning corporate risk prevention into a fluid, shared resource.'
                      : 'Abbattere le barriere culturali, linguistiche e psicologiche, rendendo la prevenzione dei rischi aziendali una risorsa fluida e partecipata.'}
                  </p>
                </div>
              </div>
                ...
                return (
                  <button
                    ...
                    className={`p-6 rounded-2xl flex flex-col justify-between text-left transition-all duration-300 border h-[190px] w-full ${
                      isSelected 
                        ? 'bg-white border-[#F2C400] shadow-[0_8px_30px_rgba(242,196,0,0.12)] scale-[1.01]' 
                        : 'bg-white/50 hover:bg-white border-black/5 hover:border-[#F2C400]/30 hover:shadow-sm'
                    }`}
                  >
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        <div className={`p-2 rounded-lg ${
                          isSelected ? 'bg-[#F2C400]/20 text-[#2C2C2E]' : 'bg-[#2C2C2E]/5 text-[#2C2C2E]/70'
                        }`}>
              ...
              <div className="h-full rounded-[24px] border border-black/5 bg-white shadow-[0_12px_40px_rgba(44,44,46,0.04)] overflow-hidden flex flex-col">
                ...
                <div className="p-4 bg-[#2C2C2E] text-white flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-full bg-[#F2C400]/10 flex items-center justify-center border border-[#F2C400]/20">
                      <MessageSquare className="w-4 h-4 text-[#F2C400]" />
                    </div>
                    <div>
                      <h4 className="text-xs font-bold uppercase tracking-wider text-white">SALVATORE AI</h4>
                      <p className="text-[9px] text-[#F2C400] font-mono">{isEn ? 'Active Virtual Consultant' : 'Consulente Virtuale Attivo'}</p>
                    </div>
                  </div>
                  ...
                  <AnimatePresence mode="wait">
                    ...
                    >
                      ...
                      <div className="flex justify-end">
                        <div className="bg-[#2C2C2E] text-white text-xs leading-relaxed font-mono px-4 py-3 rounded-2xl rounded-tr-sm max-w-[85%] border border-[#F2C400]/10 shadow-sm">
                          <p className="font-semibold text-[10px] text-[#F2C400] uppercase tracking-wider mb-1">{isEn ? 'You' : 'Tu'}</p>
                      ...
                      <div className="flex justify-start">
                        <div className="bg-[#F0EFEB]/60 border border-black/5 text-[#2C2C2E] text-xs leading-relaxed font-mono px-4 py-3 rounded-2xl rounded-tl-sm max-w-[85%] shadow-sm">
                          <p className="font-semibold text-[10px] text-[#F2C400] uppercase tracking-wider mb-1">Salvatore AI</p>
                ...
                <div className="p-3 border-t border-black/5 bg-white flex items-center justify-between gap-2">
                  ...
                  <div className="p-2 bg-[#F2C400] text-[#2C2C2E] rounded-full">
      ...
      <section id="come-funziona" className="py-24 bg-white text-left relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="mt-2 text-xs sm:text-sm font-mono text-[#F2C400] font-bold uppercase tracking-wider">
          ...
          <div className="relative mt-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-stretch relative z-10">
              ...
              <div className="space-y-4 text-center lg:text-left flex flex-col items-center lg:items-start group cursor-pointer p-4 rounded-2xl hover:bg-white/60 transition-all duration-300">
                <div className="salvatore-flow-number w-16 h-16 rounded-full bg-white/90 border border-black/10 text-[#2C2C2E] flex items-center justify-center font-bold text-lg font-mono relative shadow-sm group-hover:scale-110 group-hover:bg-[#F2C400] group-hover:border-[#F2C400] group-hover:shadow-[0_0_0_8px_rgba(242,196,0,0.16),0_12px_30px_rgba(44,44,46,0.14)] transition-all duration-300">
                  1
                  <span className="absolute -top-1 -right-1 w-3 h-3 bg-[#F2C400] rounded-full border border-white group-hover:scale-125 transition-transform" />
                </div>
                <h3 className="text-lg font-bold font-sans text-[#2C2C2E] tracking-tight group-hover:text-[#F2C400] transition-colors">
                  {isEn ? 'Reads' : 'Legge'}
                </h3>
            ...
            <div className="lg:col-span-7 relative bg-white/80 border border-black/5 rounded-[32px] p-3 sm:p-10 flex items-center justify-center min-h-[350px] sm:min-h-[440px] shadow-sm overflow-hidden">
              ...
              <svg className="absolute inset-0 w-full h-full pointer-events-none z-0" viewBox="0 0 400 320" preserveAspectRatio="none">
                ...
                <line 
                  ...
                  stroke={hoveredNode === 'salvatore' || hoveredNode === 'dailyplatform' ? '#F2C400' : 'rgba(242, 196, 0, 0.4)'} 
                ...
                <line 
                  ...
                  stroke={hoveredNode === 'salvatore' || hoveredNode === 'widiu' ? '#F2C400' : 'rgba(242, 196, 0, 0.4)'} 
                ...
                <line 
                  ...
                  stroke={hoveredNode === 'salvatore' || hoveredNode === 'vera' ? '#F2C400' : 'rgba(242, 196, 0, 0.4)'} 
                ...
                <line 
                  ...
                  stroke={hoveredNode === 'salvatore' || hoveredNode === 'dailybydaily' ? '#F2C400' : 'rgba(242, 196, 0, 0.4)'} 
                ...
                <div 
                  ...
                  className={`absolute top-0 left-0 p-2 sm:p-3.5 rounded-xl sm:rounded-2xl border transition-all duration-300 flex items-center gap-1.5 sm:gap-2.5 bg-white cursor-pointer ${
                    hoveredNode === 'dailyplatform'
                      ? 'border-[#F2C400] shadow-[0_8px_20px_rgba(242,196,0,0.22)] scale-105'
                      : 'border-black/5 hover:border-[#F2C400]/60'
                  }`}
                >
                ...
                <div 
                  ...
                  className={`p-2.5 sm:p-5 rounded-xl sm:rounded-2xl border-2 transition-all duration-300 flex flex-col items-center justify-center text-center cursor-pointer bg-white z-20 ${
                    hoveredNode === 'salvatore'
                      ? 'border-[#F2C400] shadow-[0_12px_36px_rgba(242,196,0,0.3)] scale-105 sm:scale-110'
                      : 'border-[#F2C400] shadow-[0_8px_25px_rgba(44,44,46,0.08)] hover:scale-105'
                  }`}
                >
                  <div className="p-1.5 sm:p-2.5 rounded-lg sm:rounded-xl bg-[#F2C400] text-[#2C2C2E] mb-1 sm:mb-1.5 shadow-sm">
                  ...
                  <span className="text-[7.5px] sm:text-[8.5px] font-mono font-bold uppercase text-[#2C2C2E]/70 px-1.5 sm:px-2 py-0.5 rounded bg-[#F2C400]/25 mt-0.5 sm:mt-1">
                    {isEn ? 'AI Assistant' : 'Assistente IA'}
                  </span>
                </div>
              ...
              <div className="space-y-3 pt-2">
                ...
                <div 
                  ...
                  className={`p-3.5 rounded-2xl bg-white border transition-all duration-300 cursor-pointer ${
                    hoveredNode === 'dailyplatform' ? 'border-[#F2C400] shadow-sm bg-white' : 'border-black/5 hover:border-[#F2C400]/50'
                  }`}
                >
                  <div className="flex items-center gap-2 text-xs font-bold font-sans text-[#2C2C2E]">
                    <Network className="w-3.5 h-3.5 text-[#F2C400] shrink-0" />
                ...
                <div 
                  ...
                  onMouseLeave={() => setHoveredNode(null)}
                  className={`p-3.5 rounded-2xl bg-white border transition-all duration-300 cursor-pointer ${
                    hoveredNode === 'widiu' ? 'border-[#F2C400] shadow-sm bg-white' : 'border-black/5 hover:border-[#F2C400]/50'
                  }`}
                >
                  <div className="flex items-center gap-2 text-xs font-bold font-sans text-[#2C2C2E]">
                    <Cpu className="w-3.5 h-3.5 text-[#F2C400] shrink-0" />
                    <span>WIDIU</span>
                  </div>
                  <p className="text-[11px] font-mono text-[#5E5E62] mt-1 pl-5">
                ...
                <div 
                  ...
                  onMouseLeave={() => setHoveredNode(null)}
                  className={`p-3.5 rounded-2xl bg-white border transition-all duration-300 cursor-pointer ${
                    hoveredNode === 'vera' ? 'border-[#F2C400] shadow-sm bg-white' : 'border-black/5 hover:border-[#F2C400]/50'
                  }`}
                >
                  <div className="flex items-center gap-2 text-xs font-bold font-sans text-[#2C2C2E]">
                    <Layers className="w-3.5 h-3.5 text-[#F2C400] shrink-0" />
                    <span>Vera</span>
                  </div>
                  <p className="text-[11px] font-mono text-[#5E5E62] mt-1 pl-5">
                ...
                <div 
                  ...
                  onMouseLeave={() => setHoveredNode(null)}
                  className={`p-3.5 rounded-2xl bg-white border transition-all duration-300 cursor-pointer ${
                    hoveredNode === 'dailybydaily' ? 'border-[#F2C400] shadow-sm bg-white' : 'border-black/5 hover:border-[#F2C400]/50'
                  }`}
                >
                  <div className="flex items-center gap-2 text-xs font-bold font-sans text-[#2C2C2E]">
                    <Users className="w-3.5 h-3.5 text-[#F2C400] shrink-0" />
      ...
      <section className="py-24 bg-white text-left relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-stretch">
            ...
            {/* Lavoratori */}
            <div className="p-8 rounded-[24px] bg-[#F0EFEB]/40 border border-black/5 hover:border-[#F2C400]/70 hover:shadow-[0_18px_44px_rgba(44,44,46,0.12)] hover:bg-white hover:-translate-y-1.5 transition-all duration-300 flex flex-col justify-between h-[210px] group cursor-pointer">
              <div>
                ...
                <h3 className="text-lg font-bold font-sans text-[#2C2C2E] mt-2 mb-3 tracking-tight group-hover:text-[#F2C400] transition-colors">{isEn ? 'Workers' : 'Lavoratori'}</h3>
            ...
            <div className="p-8 rounded-[24px] bg-[#F0EFEB]/40 border border-black/5 hover:border-[#F2C400]/70 hover:shadow-[0_18px_44px_rgba(44,44,46,0.12)] hover:bg-white hover:-translate-y-1.5 transition-all duration-300 flex flex-col justify-between h-[210px] group cursor-pointer">
              <div>
                ...
                <h3 className="text-lg font-bold font-sans text-[#2C2C2E] mt-2 mb-3 tracking-tight group-hover:text-[#F2C400] transition-colors">{isEn ? 'Supervisors' : 'Preposti'}</h3>
                <p className="text-[11.5px] leading-relaxed font-mono text-[#5E5E62]">
            ...
            <div className="p-8 rounded-[24px] bg-[#F0EFEB]/40 border border-black/5 hover:border-[#F2C400]/70 hover:shadow-[0_18px_44px_rgba(44,44,46,0.12)] hover:bg-white hover:-translate-y-1.5 transition-all duration-300 flex flex-col justify-between h-[210px] group cursor-pointer">
              <div>
                ...
                <h3 className="text-lg font-bold font-sans text-[#2C2C2E] mt-2 mb-3 tracking-tight group-hover:text-[#F2C400] transition-colors">{isEn ? 'RSPP & HSE Managers' : 'RSPP e HSE Manager'}</h3>
                <p className="text-[11.5px] leading-relaxed font-mono text-[#5E5E62]">
            ...
            <div className="p-8 rounded-[24px] bg-[#F0EFEB]/40 border border-black/5 hover:border-[#F2C400]/70 hover:shadow-[0_18px_44px_rgba(44,44,46,0.12)] hover:bg-white hover:-translate-y-1.5 transition-all duration-300 flex flex-col justify-between h-[210px] group cursor-pointer">
              <div>
                ...
                <h3 className="text-lg font-bold font-sans text-[#2C2C2E] mt-2 mb-3 tracking-tight group-hover:text-[#F2C400] transition-colors">{isEn ? 'Employers' : 'Datori di lavoro'}</h3>
                <p className="text-[11.5px] leading-relaxed font-mono text-[#5E5E62]">
      ...
      <section className="py-20 bg-white text-left relative border-t border-[#2C2C2E]/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="p-8 sm:p-12 rounded-[32px] bg-[#2C2C2E] text-white border border-[#F2C400]/25 shadow-xl relative overflow-hidden flex flex-col md:flex-row items-center md:items-start gap-8 w-full">
            <div className="absolute top-0 right-0 w-[300px] h-[300px] bg-[#F2C400]/5 rounded-full blur-[100px] pointer-events-none" />
            
            {/* Warning Shield Icon */}
            <div className="p-4 rounded-2xl bg-[#F2C400]/10 text-[#F2C400] border border-[#F2C400]/25 shrink-0">
              <ShieldAlert className="w-8 h-8 stroke-[1.75]" />
            </div>

            <div className="space-y-4 text-center md:text-left">
              <span className="text-[9px] font-mono font-bold uppercase tracking-widest text-[#F2C400]">
      ...
      <section className="py-24 bg-[#F0EFEB] text-left border-t border-[#2C2C2E]/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="p-10 rounded-[32px] bg-white border border-[#F2C400]/15 shadow-sm text-center space-y-6">
            <span className="text-[10px] sm:text-[11px] font-bold uppercase tracking-widest text-[#2C2C2E]/60 font-mono">
